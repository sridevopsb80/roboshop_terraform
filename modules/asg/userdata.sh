...
ansible-pull -i localhost, -U https://github.com/sridevopsb80/roboshop-ansible main.yml -e env=${env} -e role_name=docker -e app_name=${app_name} -e vault_token=${vault_token} 2>&1 | tee -a /opt/userdata.log
